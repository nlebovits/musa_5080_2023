...
When using numerous predictors in a model, it is important to inspect for colinearity, or how similar or correlated predictors are to each other. We explored these relationships between features by examining a correlation matrix. As shown in Figure xx, some variables such as {var1} and {var2} have strong colinearity. Taking note of these patterns, we still kept our subset of predictors as our next step accounts for colinearity.
